...
description: "Use after code changes to write new tests, run the existing suite, analyse failures, and repair them without weakening assertions. Invoke following a feature, a refactor, or a bug fix to keep coverage and suite health intact."
color: cyan
---
