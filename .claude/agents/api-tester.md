---
name: api-tester
description: "Use for API testing — load and stress testing, performance profiling, contract validation against OpenAPI specs, integration testing, and chaos testing. Invoke when an API must be proven robust under traffic spikes, or when response times, throughput, and error rates need measuring before deployment."
