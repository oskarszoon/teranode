...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		BlockValidation: BlockValidationSettings{
			...
			ArePreviousBlocksProcessedMaxRetry:               getInt("blockvalidation_isParentMined_retry_max_retry", 45, alternativeContext...),
			ArePreviousBlocksProcessedRetryBackoffMultiplier: getInt("blockvalidation_isParentMined_retry_backoff_multiplier", 4, alternativeContext...),
			ArePreviousBlocksProcessedRetryBackoffDuration:   getDuration("blockvalidation_isParentMined_retry_backoff_duration", 20*time.Millisecond),
