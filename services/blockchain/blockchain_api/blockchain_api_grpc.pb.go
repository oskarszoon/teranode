...
const (
	...
	BlockchainAPI_ReadFSMState_FullMethodName                         = "/blockchain_api.BlockchainAPI/ReadFSMState"
...
type BlockchainAPIClient interface {
	...
	// ReadFSMState returns the uncached, persistence-confirmed state. Unready,
	// busy or uncertain authority returns Unavailable instead of synthetic IDLE.
	ReadFSMState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetFSMStateResponse, error)
...
func (c *blockchainAPIClient) ReadFSMState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetFSMStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFSMStateResponse)
	err := c.cc.Invoke(ctx, BlockchainAPI_ReadFSMState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlockchainAPIServer interface {
	...
	// ReadFSMState returns the uncached, persistence-confirmed state. Unready,
	// busy or uncertain authority returns Unavailable instead of synthetic IDLE.
	ReadFSMState(context.Context, *emptypb.Empty) (*GetFSMStateResponse, error)
	// WaitUntilFSMTransitionFromIdleState waits for FSM to transition from IDLE state.
...
func (UnimplementedBlockchainAPIServer) ReadFSMState(context.Context, *emptypb.Empty) (*GetFSMStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReadFSMState not implemented")
}
...
func _BlockchainAPI_ReadFSMState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockchainAPIServer).ReadFSMState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlockchainAPI_ReadFSMState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockchainAPIServer).ReadFSMState(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlockchainAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReadFSMState",
			Handler:    _BlockchainAPI_ReadFSMState_Handler,
		},
		{
