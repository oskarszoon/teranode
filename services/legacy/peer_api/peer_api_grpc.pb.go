...
func (c *peerServiceClient) FetchHeadersFromPeer(ctx context.Context, in *FetchHeadersFromPeerRequest, opts ...grpc.CallOption) (*FetchHeadersFromPeerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FetchHeadersFromPeerResponse)
	err := c.cc.Invoke(ctx, PeerService_FetchHeadersFromPeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *peerServiceClient) FetchBlockFromPeer(ctx context.Context, in *FetchBlockFromPeerRequest, opts ...grpc.CallOption) (*FetchBlockFromPeerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FetchBlockFromPeerResponse)
	err := c.cc.Invoke(ctx, PeerService_FetchBlockFromPeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPeerServiceServer) FetchHeadersFromPeer(context.Context, *FetchHeadersFromPeerRequest) (*FetchHeadersFromPeerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchHeadersFromPeer not implemented")
}
...
func _PeerService_FetchHeadersFromPeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchHeadersFromPeerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PeerServiceServer).FetchHeadersFromPeer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PeerService_FetchHeadersFromPeer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerServiceServer).FetchHeadersFromPeer(ctx, req.(*FetchHeadersFromPeerRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PeerService_FetchBlockFromPeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchBlockFromPeerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PeerServiceServer).FetchBlockFromPeer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PeerService_FetchBlockFromPeer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerServiceServer).FetchBlockFromPeer(ctx, req.(*FetchBlockFromPeerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PeerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FetchHeadersFromPeer",
			Handler:    _PeerService_FetchHeadersFromPeer_Handler,
		},
		{
			MethodName: "FetchBlockFromPeer",
