...
| MaxIncomingBlockMessageBytes | int64 | 134217728 | blockvalidation_max_incoming_block_message_bytes | Per-block transport cap, additionally bounded by the aggregate response allowance |
