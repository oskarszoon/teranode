...
type KafkaInvalidSubtreeTopicMessage struct {
	...
	PeerId        string                 `protobuf:"bytes,4,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"` // ID of the peer whose DataHub served the invalid bytes (authoritative attribution)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KafkaInvalidSubtreeTopicMessage) GetPeerId() string {
	if x != nil {
		return x.PeerId
	}
	return ""
...
const file_util_kafka_kafka_message_kafka_messages_proto_rawDesc = "" +
	...
	"\apeer_id\x18\x04 \x01(\tR\x06peerId\"Y\n" +
